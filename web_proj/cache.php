        ...
        <table class="table table-hover table-bordered">
            <tbody>
                <tr>
                    ...
                    <th class="table-header">Server Exec Time</th>
                    <th class="table-header">Download Time</th>
                    <th class="table-header">Entity Resolution Time</th>
                ...
                <?php
                    foreach($results as $row):
                        ...
                        $elapsed_time = round($row['elapsed_time'], 3);
                        $server_exec_time = round($row['server_execution_time'], 3);
                        $download_time = round($row['download_time'], 3);
                        $entity_resolution_time = round($row['entity_resolution_time'], 3);
                ?>
                    <tr>
                        ...
                        <td class="table-data"><?php echo $elapsed_time; ?> sec</td>
